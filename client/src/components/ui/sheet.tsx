...
// ✅ Header / Footer / Title / Description props
...
const SheetFooter = ({ className, ...props }: SheetSectionProps) => (
  <div className={cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2", className ?? "")} {...props} />
);
SheetFooter.displayName = "SheetFooter";

type SheetTextProps = React.ComponentPropsWithoutRef<typeof SheetPrimitive.Title> & { className?: string };

const SheetTitle = React.forwardRef<HTMLHeadingElement, SheetTextProps>(
  ({ className, ...props }, ref) => (
...
const SheetDescription = React.forwardRef<HTMLParagraphElement, SheetTextProps>(
  ({ className, ...props }, ref) => (
